...
data_2.to_csv("saved_runs/variable_digit_add_50/data_lin_classifier.csv", index=False)
# Add the carry columns
add_carry_columns_to_df("saved_runs/variable_digit_add_50/data_lin_classifier.csv")